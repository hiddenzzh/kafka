 ...
 * just log the errors.
 * <p>
 * ConsumerInterceptor callbacks are called from the same thread that invokes {@link KafkaConsumer#poll(long)}.
 * <p>
...
public interface ConsumerInterceptor<K, V> extends Configurable {
    ...
    /**
     * This is called just before the records are returned by {@link KafkaConsumer#poll(long)}
     * <p>
