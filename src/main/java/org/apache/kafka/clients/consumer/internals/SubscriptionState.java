...
public class SubscriptionState {
    ...
    private final PartitionStates<TopicPartitionState> assignment;//用来保存消费者对所订阅的每个TopicPartition的消费情况
    ...
    private static class TopicPartitionState {
        private Long position; // last consumed position 下一次拉取消息的起始位置
        private Long highWatermark; // the high watermark from last fetch
        private Long lastStableOffset;
        private OffsetAndMetadata committed;  // last committed position 最近一次已提交消息的位置committed字段
