...
public class Selector implements Selectable, AutoCloseable {
     ...
     */
    public Selector(int maxReceiveSize,//NetworkReceive.UNLIMITED
            long connectionMaxIdleMs,//540,000
            Metrics metrics,
            Time time,
            String metricGrpPrefix,
            Map<String, String> metricTags,
            boolean metricsPerConnection,//true
            boolean recordTimePerConnection,//false
    ...
    private static class IdleExpiryManager {
        ...
        public IdleExpiryManager(Time time, long connectionsMaxIdleMs) {
            ...
            this.lruConnections = new LinkedHashMap<>(16, .75F, true);//LRU 最近最少使用
